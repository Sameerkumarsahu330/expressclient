...
function SearchBar() {
  ...
  <div className="w-[90vw] mx-auto sm:mx-0 sm:w-[30vw] xl:w-96">
    <div className="relative flex w-full flex-wrap items-stretch rounded border border-solid border-neutral-300">
      ...
      {/* <!--Search icon--> */}
      <button onClick={console.log('clicked search')} className="input-group-text flex items-center whitespace-nowrap rounded px-3 py-1.5 text-center text-base font-normal text-gray-800 cursor-pointer" id="basic-addon2">
